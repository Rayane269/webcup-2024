...
import brand2 from "$/storage/brand/br-2.png";
import brand3 from "$/storage/brand/br-3.png";
import brand4 from "$/storage/brand/br-4.png";
import brand5 from "$/storage/brand/br-5.png";
